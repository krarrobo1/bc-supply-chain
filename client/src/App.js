...
class App extends Component {
  ...
  componentDidMount = async () => {
    try {
      ...
      const itemManagerNetwork = ItemManagerContract.networks[this.networkId];
      const itemNetwork = ItemContract.networks[this.networkId]

      this.itemManager = new this.web3.eth.Contract(
        ItemManagerContract.abi,
        itemManagerNetwork && itemManagerNetwork.address,
      );
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <h2>Items</h2>
        <h2 href="#">Add items</h2>

          Cost in Wei
        <input type="text" name="cost" value={this.state.cost} onChange={this.handleInputChange}></input>
          Identifier
